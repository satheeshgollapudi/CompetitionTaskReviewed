...
namespace MarsFramework
{
    internal class Profile
    {
        ...
        private IWebElement AvailabilityHourOpt { get; set; }
        ...
        internal void EditProfile()
        {
            ...
            AvailabilityHourOpt.Click();
             AvailabilityHourOpt.SendKeys(Keys.ArrowDown);
            AvailabilityHourOpt.SendKeys(Keys.ArrowDown);
            AvailabilityHourOpt.SendKeys(Keys.Enter);
